...
<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
    <!--begin::Heading-->
    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url({{ asset('demo1/media/misc/pattern-1.jpg') }})">
        <!--begin::Title-->
    ...
    <div class="row g-0">
        <!--begin:Item-->
        <div class="col-6">
            <a href="?page=pages/projects/budget" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="?page=pages/projects/settings" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="?page=pages/projects/list" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="?page=pages/projects/users" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
